...
public class personnalController {
    ...
    public String openSuperman(@Valid SuperManVo superManVo) throws Exception {
        return superManPayService.wxPay(superManVo);
    }
        ...
        if ("SUCCESS".equals(resultMap.get("return_code"))) {
            ...
            if (isCheckSign) {
               ...
               /* String phone;
                ...
                personnalService.createMember("13260902007",30);
                //xxxx();
    ...
    public ReturnResult isMember(@CurrentUser SumVo sumVo){
        ...
        if(nowTime>endTime-createTime&&nowTime<endTime){
